...
#ifndef __IC3_PLATFORM_CONFIG_SIMDEXT_H__
#define __IC3_PLATFORM_CONFIG_SIMDEXT_H__
...
#if( ( IC3_PCL_COMPILER & IC3_PCL_COMPILER_CLANG ) && ( IC3_PCL_COMPILER <= IC3_PCL_COMPILER_CLANG_7 ) )
#  define __IC3_PRAGMA_DIAGNOSTIC_POP_CLANG 1
#  pragma clang diagnostic push
#  pragma clang diagnostic ignored "-Wpsabi"
#endif

#if( IC3_PCL_COMPILER & IC3_PCL_COMPILER_GCC )
#  define __IC3_PRAGMA_DIAGNOSTIC_POP_GCC 1
...
{
#if( ( IC3_PCL_EIS_SUPPORT_LEVEL & IC3_PCL_EIS_FEATURE_SSE41 ) && IC3_PCL_EIS_USE_DP_INTRINSICS )
...
#if( IC3_PCL_EIS_SUPPORT_LEVEL & IC3_PCL_EIS_FEATURE_AVX )
...
{
#if( ( IC3_PCL_EIS_SUPPORT_LEVEL & IC3_PCL_EIS_FEATURE_AVX2 ) && IC3_PCL_EIS_USE_DP_INTRINSICS )
	// Compute using intrinsic, specify distribution mask only for the first component of the result vector.
...
#if( __IC3_PRAGMA_DIAGNOSTIC_POP_GCC )
#  pragma GCC diagnostic pop
#endif

#if( __IC3_PRAGMA_DIAGNOSTIC_POP_CLANG )
#  pragma clang diagnostic pop
#endif

#endif /* IC3_PCL_FEATURE_EIS */

#endif /* __IC3_PLATFORM_CONFIG_SIMDEXT_H__ */
