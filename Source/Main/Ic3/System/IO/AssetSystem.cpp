...
namespace Ic3::System
{
	...
	io_size_t Asset::ReadData( void * pTargetBuffer, io_size_t pTargetBufferSize, io_size_t pReadSize )
	{
	...
	io_size_t Asset::ReadData( cppx::memory_buffer & pBuffer, io_size_t pReadSize )
	{
		return ReadData( pBuffer.data(), pBuffer.size(), pReadSize );
	}

	io_offset_t Asset::SetReadPointer( io_offset_t pOffset, EIOPointerRefPos pRefPos )
	{
	...
	{
		_NativeSetReadPointer( 0, EIOPointerRefPos::StreamBase );
	}
