...
namespace Ic3::System
{
	...
	inline constexpr dsm_index_t CX_DSM_INDEX_INVALID = QLimits<dsm_index_t>::maxValue - 1;

	/// @brief
	inline constexpr dsm_index_t CX_DSM_INDEX_DEFAULT = QLimits<dsm_index_t>::maxValue;

	/// @brief
	inline constexpr dsm_output_id_t CX_DSM_OUTPUT_ID_DEFAULT = QLimits<dsm_output_id_t>::maxValue;

	/// @brief Represents invalid display settings hash. Used to identify/report invalid and/or empty configurations.
	inline constexpr dsm_video_settings_hash_t CX_DSM_VIDEO_SETTINGS_HASH_INVALID = QLimits<dsm_video_settings_hash_t>::maxValue;
