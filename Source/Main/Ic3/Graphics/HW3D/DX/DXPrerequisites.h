...
#if( IC3_BUILD_STATIC )
#  define IC3_GX_DX_API
#  define IC3_GX_DX_CLASS
#  define IC3_GX_DX_OBJ    extern
#else
#  if( IC3_GRAPHICS_HW3D_DX_BUILD )
#    define IC3_GX_DX_API    PCL_ATTR_DLL_EXPORT
#    define IC3_GX_DX_CLASS  PCL_ATTR_DLL_EXPORT
#    define IC3_GX_DX_OBJ    PCL_ATTR_DLL_EXPORT
#  else
#    define IC3_GX_DX_API    PCL_ATTR_DLL_IMPORT
#    define IC3_GX_DX_CLASS  PCL_ATTR_DLL_IMPORT
#    define IC3_GX_DX_OBJ    PCL_ATTR_DLL_IMPORT
#  endif
#endif
