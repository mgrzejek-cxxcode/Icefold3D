...
namespace Ic3
{
	...
	#define Ic3TypeInfoEnumDeclareAPI( pModuleAPISpec, TPEnum ) \
		namespace _typeinfo {                                                                              \
			/* Forward declaration of an enum-specific query function, e.g. queryEnumTypeInfoColor() */    \
			pModuleAPISpec ::Ic3::EnumTypeInfo<TPEnum> & QueryEnumTypeInfo##TPEnum();                      \
			pModuleAPISpec const std::string & ToString##TPEnum( TPEnum );                                 \
		}                                                                                                  \
		/* Implementation of QueryEnumTypeInfo<TPEnum> template function specialization. */                 \
		template <> inline const ::Ic3::EnumTypeInfo<TPEnum> & QueryEnumTypeInfo<TPEnum>()                   \
		{                                                                                                  \
	...
	#define Ic3TypeInfoEnumDeclareCoreLib( TPEnum ) \
		Ic3TypeInfoEnumDeclareAPI( IC3_CORELIB_API, TPEnum )
