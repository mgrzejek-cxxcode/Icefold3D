...
#ifndef  __CPPX_PLATFORM_CONFIG_INTERNAL_OS_ANDROID_H__
#define  __CPPX_PLATFORM_CONFIG_INTERNAL_OS_ANDROID_H__
...
#endif /*  __CPPX_PLATFORM_CONFIG_INTERNAL_OS_ANDROID_H__ */
